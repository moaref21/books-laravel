    ...
    <div class="card mb-4 col-md-8">
        ...
        <div class="card-body">
            <form action="{{route('categories.update',$category)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="desciption" class="col-md-4 col-form-label text-md-right">الوصف</label>

                    <div class="col-md-6">
                        <textarea id="desciption" type="text" class="form-control @error('desciption') is-invalid @enderror" name="desciption" autocomplete="desciption">{{ $category->desciption }}</textarea>
