        ...
        <div class="card-body">
            <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="description" type="text" class="form-control @error('desciption') is-invalid @enderror" name="desciption" autocomplete="desciption">{{ old('desciption') }}</textarea>
