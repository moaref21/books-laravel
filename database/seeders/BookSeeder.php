...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        $book1 = Book::create([
            ...
            'publisher_id' => Publisher::where('name', 'انس معرف')->first()->id,
        ...
        $book1->Authers()->attach(Auther::where('name', 'فاطمة حيشية')->first());
        ...
        $book2->Authers()->attach(Auther::where('name', 'محمد عرابي')->first());
        ...
        $book3->Authers()->attach(Auther::where('name', 'محمد الزاير')->first());
        ...
        $book4->Authers()->attach(Auther ::where('name', 'عمر النواوي')->first());
        ...
        $book5->Authers()->attach(Auther::where('name', 'ماجد عطوي')->first());
        ...
        $book6->Authers()->attach(Auther::where('name', 'رياض سامر')->first());
    }
}
